    ...
    <>
        ...
        @media print {
          ...
          *, *::before, *::after {
          ...
          #one-page-summary-report {
            ...
            margin: 0 !important;
            padding: ${isLandscape ? '5mm 8mm 4mm 8mm' : '7mm 9mm 6mm 9mm'} !important;
      ...
      >
        ...
        <div className="flex-1 flex flex-col justify-between min-h-0">
          <div>
            {/* 1. Header Banner */}
            <div className="border-b-2 border-indigo-900 pb-2 mb-2.5">
          ...
          {isLandscape ? (
            ...
            <div className="grid grid-cols-12 gap-3 mb-2.5 flex-1 items-stretch min-h-0">
              ...
              <div className="col-span-7 flex flex-col gap-2 min-h-0">
                ...
                <div className="grid grid-cols-2 gap-2 flex-1 min-h-0">
                  {/* 1. กิจกรรมดำเนินการ */}
                  <div className="p-2.5 bg-gradient-to-br from-indigo-50/60 via-indigo-50/20 to-white border border-indigo-100/90 rounded-xl shadow-2xs flex flex-col justify-start overflow-hidden">
                    <h3 className="text-xs font-bold text-indigo-950 flex items-center gap-1.5 border-b border-indigo-100 pb-1 mb-1.5 shrink-0">
                    ...
                    <div className={`text-slate-700 whitespace-pre-line leading-relaxed overflow-y-auto pr-1 ${
                      activitiesSummary.length > 350 ? 'text-[9.5px] leading-snug' : activitiesSummary.length > 200 ? 'text-[10px] leading-relaxed' : 'text-[10.5px] leading-relaxed'
                    }`}>
                      {activitiesSummary}
                    </div>
                  </div>
                  ...
                  {/* 2. ผลที่ได้รับ */}
                  <div className="p-2.5 bg-gradient-to-br from-emerald-50/60 via-emerald-50/20 to-white border border-emerald-100/90 rounded-xl shadow-2xs flex flex-col justify-start overflow-hidden">
                    <h3 className="text-xs font-bold text-emerald-950 flex items-center gap-1.5 border-b border-emerald-100 pb-1 mb-1.5 shrink-0">
                    ...
                    <div className={`text-slate-700 whitespace-pre-line leading-relaxed overflow-y-auto pr-1 ${
                      actualResults.length > 350 ? 'text-[9.5px] leading-snug' : actualResults.length > 200 ? 'text-[10px] leading-relaxed' : 'text-[10.5px] leading-relaxed'
                    }`}>
                      {actualResults}
                    </div>
                  </div>
                ...
                <div className="grid grid-cols-2 gap-2 shrink-0">
                  {/* 3. ปัญหาและอุปสรรค */}
                  <div className="p-2.5 bg-gradient-to-br from-amber-50/60 via-amber-50/20 to-white border border-amber-100/90 rounded-xl shadow-2xs flex flex-col justify-start overflow-hidden">
                    <h3 className="text-xs font-bold text-amber-950 flex items-center gap-1.5 border-b border-amber-100 pb-1 mb-1.5 shrink-0">
                    ...
                    <div className={`text-slate-700 whitespace-pre-line leading-relaxed overflow-y-auto pr-1 ${
                      problemsObstacles.length > 200 ? 'text-[9.5px] leading-snug' : 'text-[10px] leading-relaxed'
                    }`}>
                      {problemsObstacles}
                    </div>
                  </div>
                  ...
                  <div className="p-2.5 bg-gradient-to-br from-blue-50/60 via-blue-50/20 to-white border border-blue-100/90 rounded-xl shadow-2xs flex flex-col justify-start overflow-hidden">
                    <h3 className="text-xs font-bold text-blue-950 flex items-center gap-1.5 border-b border-blue-100 pb-1 mb-1.5 shrink-0">
                    ...
                    <div className={`text-slate-700 whitespace-pre-line leading-relaxed overflow-y-auto pr-1 ${
                      projectSuggestions.length > 200 ? 'text-[9.5px] leading-snug' : 'text-[10px] leading-relaxed'
                    }`}>
                      {projectSuggestions}
                    </div>
                  </div>
              ...
              <div className="col-span-5 bg-slate-50/80 border border-slate-200/90 rounded-xl p-2.5 shadow-2xs flex flex-col justify-between">
                <div className="flex items-center gap-1.5 text-xs font-bold text-slate-800 border-b border-slate-200 pb-1 mb-1.5 shrink-0">
            ...
            <div className="flex-1 flex flex-col justify-between min-h-0 mb-2.5">
              {/* 3. Four Core Analysis Cards (2x2 Grid with responsive text flow) */}
              <div className="grid grid-cols-1 md:grid-cols-2 gap-2.5 mb-2.5 flex-1 min-h-0">
                {/* 1. กิจกรรมดำเนินการ */}
                <div className="p-3 bg-gradient-to-br from-indigo-50/60 via-indigo-50/20 to-white border border-indigo-100/90 rounded-xl shadow-2xs flex flex-col justify-start">
                  <h3 className="text-xs font-bold text-indigo-950 flex items-center gap-1.5 border-b border-indigo-100 pb-1 mb-1.5">
                    <div className="w-4.5 h-4.5 rounded-md bg-indigo-600 text-white flex items-center justify-center text-[10px] font-black shadow-xs">๑</div>
                    <span>กิจกรรมดำเนินการ (Activities Summary)</span>
                  </h3>
                  <div className={`text-slate-700 whitespace-pre-line ${
                    activitiesSummary.length > 500 ? 'text-[10px] leading-snug' : activitiesSummary.length > 250 ? 'text-[10.5px] leading-relaxed' : 'text-[11px] leading-relaxed'
                  }`}>
                    {activitiesSummary}
                  </div>
                </div>
                ...
                {/* 2. ผลที่ได้รับ */}
                <div className="p-3 bg-gradient-to-br from-emerald-50/60 via-emerald-50/20 to-white border border-emerald-100/90 rounded-xl shadow-2xs flex flex-col justify-start">
                  <h3 className="text-xs font-bold text-emerald-950 flex items-center gap-1.5 border-b border-emerald-100 pb-1 mb-1.5">
                    <div className="w-4.5 h-4.5 rounded-md bg-emerald-600 text-white flex items-center justify-center text-[10px] font-black shadow-xs">๒</div>
                ...
                {/* 3. ปัญหา-อุปสรรค */}
                <div className="p-3 bg-gradient-to-br from-amber-50/60 via-amber-50/20 to-white border border-amber-100/90 rounded-xl shadow-2xs flex flex-col justify-start">
                  <h3 className="text-xs font-bold text-amber-950 flex items-center gap-1.5 border-b border-amber-100 pb-1 mb-1.5">
                    <div className="w-4.5 h-4.5 rounded-md bg-amber-600 text-white flex items-center justify-center text-[10px] font-black shadow-xs">๓</div>
                    <span>ปัญหาและอุปสรรค (Problems & Obstacles)</span>
                  </h3>
                  <div className={`text-slate-700 whitespace-pre-line ${
                    problemsObstacles.length > 300 ? 'text-[10px] leading-snug' : 'text-[10.5px] leading-relaxed'
                  }`}>
                    {problemsObstacles}
                  </div>
                </div>
                ...
                {/* 4. ข้อเสนอแนะ */}
                <div className="p-3 bg-gradient-to-br from-blue-50/60 via-blue-50/20 to-white border border-blue-100/90 rounded-xl shadow-2xs flex flex-col justify-start">
                  <h3 className="text-xs font-bold text-blue-950 flex items-center gap-1.5 border-b border-blue-100 pb-1 mb-1.5">
                    <div className="w-4.5 h-4.5 rounded-md bg-blue-600 text-white flex items-center justify-center text-[10px] font-black shadow-xs">๔</div>
                    <span>ข้อเสนอแนะเพื่อการพัฒนา (Suggestions)</span>
                  </h3>
                  <div className={`text-slate-700 whitespace-pre-line ${
                    projectSuggestions.length > 300 ? 'text-[10px] leading-snug' : 'text-[10.5px] leading-relaxed'
                  }`}>
                    {projectSuggestions}
                  </div>
                </div>
              ...
              <div className="bg-slate-50/80 border border-slate-200/90 rounded-xl p-2.5 shadow-2xs shrink-0">
                <div className="flex items-center gap-1.5 text-xs font-bold text-slate-800 mb-1.5 border-b border-slate-200 pb-1">
                  <ImageIcon className="w-3.5 h-3.5 text-indigo-700" />
        ...
        <div className="pt-2 border-t-2 border-slate-200 grid grid-cols-3 gap-2 text-center text-xs text-slate-800 shrink-0">
          <div className="space-y-0.5">
