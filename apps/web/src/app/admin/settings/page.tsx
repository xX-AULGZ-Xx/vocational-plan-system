...
export default function AdminSettingsPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6 pb-20">
      ...
      {/* Modal 1: เพิ่มปีงบประมาณ */}
      {showAddYearModal && (
        <ModalPortal>
          <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-md overflow-y-auto">
            <div className="bg-white rounded-2xl max-w-md w-full max-h-[calc(100dvh-2rem)] flex flex-col overflow-hidden shadow-2xl border border-slate-100 my-auto animate-in zoom-in-95">
              ...
              <form onSubmit={handleAddFiscalYear} className="flex flex-col flex-1 overflow-hidden min-h-0">
                ...
                <div className="flex items-center justify-end gap-2 p-4 sm:p-5 pt-3 border-t border-slate-100 bg-slate-50/80 shrink-0">
                  <button
                    type="button"
                    onClick={() => setShowAddYearModal(false)}
      ...
      {showScheduleModal && (
        <ModalPortal>
          <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-md overflow-y-auto">
            <div className="bg-white rounded-2xl max-w-lg w-full max-h-[calc(100dvh-2rem)] flex flex-col overflow-hidden shadow-2xl border border-slate-100 my-auto animate-in zoom-in-95">
              <div className="flex items-center justify-between p-5 sm:p-6 pb-3 border-b border-slate-100 shrink-0">
                <div className="flex items-center gap-2.5">
