...
code = code.replace(
  /<div className="lg:col-span-1">\s*<label className="block text-xs font-medium text-gray-500 mb-1">Tag ในเอกสาร<\/label>\s*<div className="px-3 py-2 bg-gray-100 rounded text-sm font-mono text-gray-700 truncate">\s*\{tag\.tag_name\}\s*<\/div>\s*<\/div>/g,
